...
export function ObtenerFoto(props) {
    ...
    //para hacer uplifting para poder poner la URL en el form de Ingreso, tiene que llegar hasta index
    const { enviarUrlImagen } = props

    // para que puedan subir dos veces el mismo archivo y que actúe el onChange
